...
void quantize_row_eden4(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
void quantize_row_eden3(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
