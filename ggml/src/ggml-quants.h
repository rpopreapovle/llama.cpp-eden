...
GGML_API void quantize_row_eden4_ref(const float * GGML_RESTRICT x, block_eden4 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_eden3_ref(const float * GGML_RESTRICT x, block_eden3 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_eden4(const block_eden4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_eden3(const block_eden3 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_eden4(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_eden3(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
