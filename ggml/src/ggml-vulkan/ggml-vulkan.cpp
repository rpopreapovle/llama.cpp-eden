...
#define CREATE_MM2(PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT) \
        ...
        CREATE_MM2(pipeline_dequant_mul_mat_mat_f16[GGML_TYPE_EDEN4],   matmul_eden4_f16,   mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3)
        CREATE_MM2(pipeline_dequant_mul_mat_mat_f16[GGML_TYPE_EDEN3],   matmul_eden3_f16,   mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3)
        ...
        CREATE_MM2(pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN4],   matmul_id_subgroup_eden4_f16,   mmqid_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, 5)
        CREATE_MM2(pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN3],   matmul_id_subgroup_eden3_f16,   mmqid_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, 5)
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID) \
        ...
        if (device->coopmat_acc_f16_support) {
            ...
            CREATE_MM2(GGML_TYPE_EDEN4,   pipeline_dequant_mul_mat_mat[GGML_TYPE_EDEN4],   matmul_eden4_f32,   mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            CREATE_MM2(GGML_TYPE_EDEN3,   pipeline_dequant_mul_mat_mat[GGML_TYPE_EDEN3],   matmul_eden3_f32,   mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            ...
            CREATE_MM(GGML_TYPE_EDEN4,   pipeline_dequant_mul_mat_mat[GGML_TYPE_EDEN4].f32acc,   matmul_eden4_f32,   , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            CREATE_MM(GGML_TYPE_EDEN3,   pipeline_dequant_mul_mat_mat[GGML_TYPE_EDEN3].f32acc,   matmul_eden3_f32,   , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
        ...
        CREATE_MM2(GGML_TYPE_EDEN4,   pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN4],   matmul_id_subgroup_eden4_f32,   mmq_wg_denoms, warptile_mmq, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id);
        CREATE_MM2(GGML_TYPE_EDEN3,   pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN3],   matmul_id_subgroup_eden3_f32,   mmq_wg_denoms, warptile_mmq, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id);
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID, REQSUBGROUPSIZE) \
        ...
        CREATE_MM2(GGML_TYPE_EDEN4,   pipeline_dequant_mul_mat_mat[GGML_TYPE_EDEN4],   matmul_eden4_f32,   mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        CREATE_MM2(GGML_TYPE_EDEN3,   pipeline_dequant_mul_mat_mat[GGML_TYPE_EDEN3],   matmul_eden3_f32,   mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        ...
        if (device->subgroup_ballot && device->subgroup_require_full_support && subgroup_min_size_16) {
            ...
            CREATE_MM2(GGML_TYPE_EDEN4,   pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN4],   matmul_id_subgroup_eden4_f32,   mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            CREATE_MM2(GGML_TYPE_EDEN3,   pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN3],   matmul_id_subgroup_eden3_f32,   mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            ...
            CREATE_MM2(GGML_TYPE_EDEN4,   pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN4],   matmul_id_eden4_f32,   mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
            CREATE_MM2(GGML_TYPE_EDEN3,   pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN3],   matmul_id_eden3_f32,   mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
...
#define CREATE_MMQ(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID) \
        ...
        CREATE_MM(GGML_TYPE_EDEN4,   pipeline_dequant_mul_mat_mat[GGML_TYPE_EDEN4].f32acc,   matmul_eden4_f32,   , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        CREATE_MM(GGML_TYPE_EDEN3,   pipeline_dequant_mul_mat_mat[GGML_TYPE_EDEN3].f32acc,   matmul_eden3_f32,   , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        ...
        if (device->subgroup_ballot && device->subgroup_require_full_support && subgroup_min_size_16) {
            ...
            CREATE_MM(GGML_TYPE_EDEN4,   pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN4].f32acc,   matmul_id_subgroup_eden4_f32,   , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            CREATE_MM(GGML_TYPE_EDEN3,   pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN3].f32acc,   matmul_id_subgroup_eden3_f32,   , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            ...
            CREATE_MM(GGML_TYPE_EDEN4,   pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN4].f32acc,   matmul_id_eden4_f32,   , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
            CREATE_MM(GGML_TYPE_EDEN3,   pipeline_dequant_mul_mat_mat_id[GGML_TYPE_EDEN3].f32acc,   matmul_id_eden3_f32,   , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
...
#undef CREATE_MM
    ...
    for (uint32_t w = 0; w < DMMV_WG_SIZE_COUNT; ++w) {
        ...
        for (uint32_t i = 0; i < mul_mat_vec_max_cols; ++i) {
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_EDEN4][i],   "mul_mat_vec_eden4_f32_f32",   arr_dmmv_eden4_f32_f32_len[reduc16],   arr_dmmv_eden4_f32_f32_data[reduc16],   "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {wg_size_subgroup16, rm_iq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_EDEN3][i],   "mul_mat_vec_eden3_f32_f32",   arr_dmmv_eden3_f32_f32_len[reduc16],   arr_dmmv_eden3_f32_f32_data[reduc16],   "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {wg_size_subgroup16, rm_iq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_EDEN4][i],   "mul_mat_vec_eden4_f16_f32",   arr_dmmv_eden4_f16_f32_len[reduc16],   arr_dmmv_eden4_f16_f32_data[reduc16],   "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {wg_size_subgroup16, rm_iq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_EDEN3][i],   "mul_mat_vec_eden3_f16_f32",   arr_dmmv_eden3_f16_f32_len[reduc16],   arr_dmmv_eden3_f16_f32_data[reduc16],   "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_iq, 1, 1}, {wg_size_subgroup16, rm_iq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_EDEN4],   "mul_mat_vec_id_eden4_f32",   arr_dmmv_id_eden4_f32_f32_len[reduc16],   arr_dmmv_id_eden4_f32_f32_data[reduc16],   "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_iq, 1, 1}, {wg_size_subgroup16, rm_iq}, 1, true, use_subgroups16, force_subgroup_size16);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_EDEN3],   "mul_mat_vec_id_eden3_f32",   arr_dmmv_id_eden3_f32_f32_len[reduc16],   arr_dmmv_id_eden3_f32_f32_data[reduc16],   "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_iq, 1, 1}, {wg_size_subgroup16, rm_iq}, 1, true, use_subgroups16, force_subgroup_size16);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_EDEN4],   "dequant_eden4",   dequant_eden4_len,   dequant_eden4_data,   "main", 2, 5 * sizeof(uint32_t), {256 * 16, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_EDEN3],   "dequant_eden3",   dequant_eden3_len,   dequant_eden3_data,   "main", 2, 5 * sizeof(uint32_t), {256 * 16, 1, 1}, {}, 1);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_get_rows[GGML_TYPE_EDEN4],   "get_rows_eden4",   get_rows_eden4_len,   get_rows_eden4_data,   "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_get_rows[GGML_TYPE_EDEN3],   "get_rows_eden3",   get_rows_eden3_len,   get_rows_eden3_data,   "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_get_rows_f32[GGML_TYPE_EDEN4],   "get_rows_eden4_f32",   get_rows_eden4_f32_len,   get_rows_eden4_f32_data,   "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_get_rows_f32[GGML_TYPE_EDEN3],   "get_rows_eden3_f32",   get_rows_eden3_f32_len,   get_rows_eden3_f32_data,   "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
