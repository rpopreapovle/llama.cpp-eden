...
template<>
struct ggml_cuda_type_traits<GGML_TYPE_EDEN4> {
    static constexpr int qk = QK_EDEN;
    static constexpr int qr = QR_EDEN;
    static constexpr int qi = QI_EDEN;
};

template<>
struct ggml_cuda_type_traits<GGML_TYPE_EDEN3> {
    static constexpr int qk = QK_EDEN;
    static constexpr int qr = QR_EDEN;
    static constexpr int qi = QI_EDEN;
};
