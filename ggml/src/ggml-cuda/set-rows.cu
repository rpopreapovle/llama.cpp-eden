...
static void set_rows_cuda(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    } else if (dst->type == GGML_TYPE_EDEN4) {
        set_rows_cuda_quant<idx_t, block_eden4, QK_EDEN, quantize_f32_eden4_block>(
            src0_d, src1_d, (block_eden4*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
    ...
    } else if (dst->type == GGML_TYPE_EDEN3) {
        set_rows_cuda_quant<idx_t, block_eden3, QK_EDEN, quantize_f32_eden3_block>(
            src0_d, src1_d, (block_eden3*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
